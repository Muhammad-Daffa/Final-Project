                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login Pengguna</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="cekloginpengguna.php">
                                            ...
                                            <?php 
                                               if(isset($_GET['pesan'])){
                                                 ...
                                                 else if($_GET['pesan'] == "terblokir"){
                                                   echo "<center><br>Akun Anda Diblokir, Silahkan ke Studio/Hubungi Admin</center>";
                                                 }
                                               }
                                              ?>
                                        </form>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Muhammad Daffa & Erindra Reynaldi 2021</div>
                        </div>
                    </div>
                </footer>
            </div>
