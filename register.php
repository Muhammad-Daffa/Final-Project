                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="simpandata.php">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputTelp" type="number" placeholder="No. Telp" name="telp" required />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="login_pengguna.php">Sudah Punya Akun? Login Sekarang!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
